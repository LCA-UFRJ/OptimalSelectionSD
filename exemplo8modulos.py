...
GfLinhaCompleta = rodarAutomatico.GfLinhaCompleta  # busca por todas as sdmb utilizando os verificadores parciais
...
def exemplo8modulos():
    ...
    eventos3 = ["F","d","h"]
    estadoInicial3 = ["0"]
    EeE3 = [["0","h","1"], ["1","h","1"], ["1","F","2"], ["2","h","2"], ["2","d","2"]]
    ...
    eventos5 = ["b","h", "F"]
    estadoInicial5 = ["0"]
    EeE5 = [["0","h","1"], ["1","h","1"], ["1","F","2"], ["2","h","2"], ["2","b","2"]]
    aut5 = Automato(estados5, eventos5, estadoInicial5, [] , EeE5, {})

    estados6 = ["0","1","2","3"]
    eventos6 = ["a","S1", "c", "g"]
    estadoInicial6 = ["0"]
    EeE6 = [["0","a","1"], ["1","S1","2"], ["2","c","3"], ["2","S1","0"], ["3","g","0"]]
    aut6 = Automato(estados6, eventos6, estadoInicial6, [] , EeE6, {})

    estados7 = ["0", "1", "2"]
    eventos7 = ["e", "h"]
    estadoInicial7 = ["0"]
    EeE7 = [["0", "h", "1"], ["0", "e", "0"], ["1", "e", "0"]]
    aut7 = Automato(estados7, eventos7, estadoInicial7, [], EeE7, {})

    estados8 = ["0", "1", "2", "3"]
    eventos8 = ["c", "S1", "g", "e"]
    estadoInicial8 = ["0"]
    EeE8 = [["0","e","2"], ["0","S1","1"], ["1","c","3"], ["3","S1","2"], ["2","e","0"], ["3","g","2"]]#[["0","a","1"], ["0","e","3"], ["1","S1","2"], ["2","c","4"], ["2","S1","3"], ["3","e","0"], ["4","g","3"]]
    aut8 = Automato(estados8, eventos8, estadoInicial8, [], EeE8, {})
    ...
    aut = [aut1, aut2, aut3, aut4, aut5, aut6, aut7, aut8]#, aut5, aut6, aut3]#, aut4]#, aut5]#, aut6]#, aut1, aut2, aut3, aut4]
    juntei = []
    autCompleto = aut1
    for a in aut:
        if juntei == []:
    ...
    #
    TempoGfLinhaArvore = (TempoFimGfLinhaArvore - TempoFimExaustivaArvore)#TempoFimGfLinhaCompleta)#TempoFimExaustivaArvore)
    #
    #
    ...
    print("TempoGfLinha - ", TempoGfLinha)
    print("TempoInteligente - ", TempoInteligente)
    print("TempoGfLinhaCompleta - ", TempoGfLinhaCompleta)
    print("tempoExaustiva - ", tempoExaustiva)
    print("TempoGfLinhaArvore - ", TempoGfLinhaArvore)
    print("tempoExaustivaArvore - ", tempoExaustivaArvore)
