...
def Principal():
    ...
    # print(ver1_2.EeE)
    # print("ver1.EeE")
    # print("transições: " + len(ver1.EeE))
    # print("estados: " + len(ver1.estados))
    # print("ver2_2.EeE")
    # print(ver2_2.EeE)
    # print("ver2.EeE")
    # print(ver2.EeE)
...
def Principal2():
    ...
    aut1n = limpaGni(automatoGni(aut1, Gn, ["F"]))
    aut2n = limpaGni(automatoGni(aut2, Gn, ["F"]))
    # aut2n.EeE = [["0", "b", "1"], ["0", "S2", "2"], ["1", "c", "0"], ["2", "c", "3"], ["3", "d", "3"],
    #         ["3", "b", "2"]]
...
def PrincipalTeste():
    ...
    estadosL = ["0", "1", "2"]  # ,"3","4"]
    eventosL = ['a', 'e', 'c', 'S1', 'g', 'F', 'h', 'S2', 'b', 'd']
    EeEL = [["0", "h", "1"], ["1", "F", "2"], ["2", "d", "2"]]
    GFL = Automato(estadosL, eventosL, ["0"], [], EeEL, {})

    estadosLL = ["0", "1", "2", "3"]  # ,"4"]
    eventosLL = ['a', 'e', 'c', 'S1', 'g', 'F', 'h', 'S2', 'b', 'd']
    EeELL = [["0", "h", "1"], ["1", "F", "2"], ["2", "h", "3"], ["3", "h", "3"]]
    GFLL = Automato(estadosLL, eventosLL, ["0"], [], EeELL, {})
    ...
    t2l = ComposicaoParalela(GFL, ver2)
    t3l = ComposicaoParalela(GFL, ver3)
    t4l = ComposicaoParalela(GFL, ver4)
    t4ll = ComposicaoParalela(GFLL, ver4)
    ...
    print("Verificador 34 -> transições:", len(ver34.EeE), " estados: ", len(ver34.estados))
    # print("Verificador 123 -> transições:", len(ver123.EeE), " estados: ", len(ver123.estados))
    print("apoio Gf'||Ver2  -> transições:", len(t2l.EeE), " estados: ", len(t2l.estados))
    print("apoio Gf'||Ver3  -> transições:", len(t3l.EeE), " estados: ", len(t3l.estados))
    print("apoio Gf'||Ver4  -> transições:", len(t4l.EeE), " estados: ", len(t4l.estados))
    print("apoio Gf''||Ver4  -> transições:", len(t4ll.EeE), " estados: ", len(t4ll.estados))
    # print("Verificador 124 -> transições:", len(ver124.EeE), " estados: ", len(ver124.estados))
    # print("Verificador 134 -> transições:", len(ver134.EeE), " estados: ", len#(ver134.estados))
    # print("Verificador 234 -> transições:", len(ver234.EeE), " estados: ", len(ver234.estados))
    # print("Verificador 1234 -> transições:", len(ver1234.EeE), " estados: ", len(ver1234.estados))
